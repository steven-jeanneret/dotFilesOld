...
aurman --needed --noconfirm --noedit -S visual-studio-code-bin # you might not need that
aurman --needed --noconfirm --noedit -S sublime-text-dev # you might not need that
